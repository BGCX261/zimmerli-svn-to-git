function symlinkControl(_id, _module, _types, _options, hierarchy_types) {
	...
	var init = function() {
		...
		treeButton.onclick = function() {			
			jQuery.openPopupLayer({
				...
				width  : 620,
				height : 335,
				url    : "/styles/common/js/tree.html?id=" + id + (module ? "&module=" + module : "" ) + htypesStr + (window.lang_id ? "&lang_id=" + window.lang_id : "")
			});
		};
