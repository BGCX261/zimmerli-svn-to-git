...
jQuery(document).ready(function() {
	...
	// ChangeParent
	jQuery("div.changeParent").each(function() {
		var e = jQuery(this);
		var l = jQuery("ul", e);
		...
		var mode = e.hasClass('virtuals');

		var s = new changeParentControl(e.attr("id"), "content",
							{inputName      : e.attr("name"),
							 fadeColorStart : [255, 255, 225],
							 fadeColorEnd   : [255, 255, 255]},
							 hTypes, mode);
		jQuery("li", e).each(function(){
			var li = jQuery(this);
			s.loadItem(li.attr("umi:id"), li.children('span')[0], {'module' : li.attr("umi:module"), 'method' : li.attr("umi:method")});
		});
		l.remove();
	});
	// Files
