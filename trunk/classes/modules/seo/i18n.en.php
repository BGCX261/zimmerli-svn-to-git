...
$i18n = Array(
	...
	'label-error-no-token'		=> '<div style="margin-bottom:20px;">Для работы с Яндекс.Вебмастер необходимо получить авторизационный токен и сохранить его в <a href="/admin/seo/config">настройках модуля</a>.
