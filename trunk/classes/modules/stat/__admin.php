        ...
        public function updateFilter() {
            try {
                ...
                if(in_array($aParam['config']['int:user'], array_keys($this->getUsersList())) || $aParam['config']['int:user']==0)
                {
                    ...
                    if(in_array($_COOKIE['stat_user'], $this->getUsersList()) || $_COOKIE['stat_user'] == 'all')
                ...
                if(isset($_COOKIE['stat_user'])) $this->user    = (in_array($_COOKIE['stat_user'], array_keys($this->getUsersList()))  || $_COOKIE['stat_user'] == 0 )
                                                                ? $_COOKIE['stat_user'] : 0;
