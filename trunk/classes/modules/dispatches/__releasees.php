...
*/
		...
		public function release_send_full($iDispId) {
			...
			foreach($sel->result() as $recipient) {
				...
				$oNextMailer->setContent(def_module::parseTemplateForMail($sReleaseFrm, $arrMailBlocks, false, $oNextSbs->getId()));
...
END;
			...
			$aSended = array();
			$iPacketSize = 5; //TODO: add to settings
