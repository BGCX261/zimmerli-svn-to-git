...
abstract class __emarket_purchasing extends def_module
{
	...
	list($tpl_block, $tpl_block_empty) = def_module::loadTemplates("emarket/" . $template, 'order_block', 'order_block_empty');
	...
	$result['void:original-price'] = $this->parsePriceTpl($template, $result['summary']['price']['actual']);
