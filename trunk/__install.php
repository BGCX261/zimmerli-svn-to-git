			...
			<div class="main">
				...
				<div class="display_none last_block text_align2 shadow_some step9">
					<div class="padding_big">
						...
						<p class="the_end_p" style="font-size: 0.9em; margin-bottom: 30px;">В целях безопасности убедитесь, что в корневой директории сайта отсутствует файл install.ini<br/><b>Если он не был удален автоматически, удалите его вручную.</b></p>
