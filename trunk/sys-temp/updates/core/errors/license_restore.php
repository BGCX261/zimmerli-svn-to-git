<?php
 require_once("../libs/config.php");$vb1444fb0c07653567ad325aa25d4e37a = regedit::getInstance();header("Content-type: text/javascript; charset=utf-8");if ($vb1444fb0c07653567ad325aa25d4e37a->checkSelfKeycode()) {echo 'jQuery(document).ready(function() {
