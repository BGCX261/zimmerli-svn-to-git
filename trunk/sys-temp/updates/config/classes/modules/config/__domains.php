<?php
	abstract class __domains_config extends baseModuleAdmin {
		...
		public function domain_mirrows() {
			...
			$additional_info['string:site_name'] = $regedit->getVal("//settings/site_name/{$domain_id}/{$lang_id}/") ? $regedit->getVal("//settings/site_name/{$domain_id}/{$lang_id}") : $regedit->getVal("//settings/site_name");
