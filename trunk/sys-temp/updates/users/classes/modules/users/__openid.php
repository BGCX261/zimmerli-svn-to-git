            ...
            if ($yadis) {
                ...
                if (isset($headers['content-type'])
                    ...
                    foreach($m[1] as $content) {
                        ...
                        # OpenID 2
                        if(preg_match('#<Type>\s*http\://specs\.openid\.net/auth/2\.0/(server|signon)\s*</Type>#s', $content, $type)) {
                        ...
                        # OpenID 1.1
                        if (preg_match('#<Type>\s*http\://openid\.net/signon/1\.1\s*</Type>#s', $content)) {
