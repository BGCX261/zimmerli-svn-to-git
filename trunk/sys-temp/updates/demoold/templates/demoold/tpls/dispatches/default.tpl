...
$FORMS['subscribe_unregistred_user'] = <<<END
	<form method="post" name="sbs_frm" enctype="multipart/form-data" action="%pre_lang%/dispatches/subscribe_do/">
		<table border="0" width="95%" class="bg_subscription">
			...
			<tr>
			     <td class="h4">
					   <!--<img src="/templates/demoold/images/spacer.gif" width="10" height="1" alt="" border="0">-->
					   ...
					   <!--<a href="javascript: document.forms['sbs_frm'].submit();" ><img src="/templates/demoold/images/submit_ok.gif" width="39" align="absmiddle" hspace="7" height="18" alt="" border="0"></a>-->
					   <input type="submit" value="Ok"/>
				</td>
			</tr>
...
$FORMS['subscribe_registred_user'] = <<<END
	<form method="post" name="sbs_frm" enctype="multipart/form-data" action="%pre_lang%/dispatches/subscribe_do/">
		<table border="0" width="95%" class="bg_subscription">
			<tr><td><img src="/templates/demoold/images/bg_subscription_top.gif" width="100%" height="12" alt=""></td></tr>
			...
			<tr><td><img src="/templates/demoold/images/bg_subscription_bot.gif" width="100%" height="12" alt=""></td></tr>
		</table>
	</form>
END;
